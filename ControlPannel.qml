...
Rectangle{
    ...
    function change(){
        if(startstop  == 0){
            ...
            speedwarning.source = "file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/warning.png"
            ...
            speedwarning.visible =true
            speedwarning.source = "file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/speedometerwarning.png"
...
//    }
    ...
    Image {
        id:wifi
        source: 1?"file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/signal.png":"file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/nosignal.png"
        anchors.top: mainrect.top
        anchors.topMargin: 7
        anchors.left:mainrect.left
    ...
    Image {
        id:loadfile
        source:"file:///C:/Users/Administrator/Downloads/f.png"
        anchors.top: mainrect.top
        ...
        MouseArea{
            ...
            onPressed: {
                if(startstop){
                    ...
                    //st =fileUrl.toString().replace("file:///","")+"|90"
                    //unityWidgetClass.changeVal(fileUrl.toString().replace("file:///","")+"|90");
                }
                else{
                    change()
                }
    ...
    FileDialog {
        ...
        onAccepted: {
            ...
            st = ("lk|"+"90|"+fileUrl.toString().replace("file:///",""));
            console.log(file);
        }
    ...
    Image {
        id:sendfile
        source:"file:///C:/Users/Administrator/Downloads/run.png"
        anchors.top: mainrect.top
        anchors.topMargin:10
        anchors.right:loadfile.left
        anchors.rightMargin: 24
        height:(mainrect.height*0.06 + mainrect.width *0.08)/2.7
        width:(mainrect.height*0.06 + mainrect.width *0.08)/2.7
        MouseArea{
            anchors.fill: sendfile
    ...
    Image {
        id:voice
        source:"file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/voice.png"
        anchors.top: mainrect.top
        anchors.topMargin:10
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                if(startstop){
                    //                wifi.source='file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/signal.png';
                    connecttext.text="Release"
                    connecttext.color="#F67280"
                    connecteffect.color="#FF4545"
                    unityWidgetClass.changeVal("pick|0");
                }
                else{
                    change();
                }
            ...
            onDoubleClicked: {
                if(startstop){
                    ...
                    unityWidgetClass.changeVal("release|0");
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: reset
            onClicked: {
                camera.source='file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/cameraoff.png'
                popup.visible=true
                notification.text ="Restore Successfull"
                notification.color ="#19CC5D"
                speedwarning.visible =true
                speedwarning.anchors.topMargin=5
                speedwarning.source ="file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/reset.png"
                ...
                startstop=unityWidgetClass.canIOff();
                speedometer.value=0
                s1.value=0
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: start
            onClicked: {
                startstop = unityWidgetClass.canISet();
                popup.visible = true
                ...
                speedwarning.visible =true
                speedwarning.anchors.topMargin=0
                speedwarning.source ="file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/pause.png"
            ...
            onDoubleClicked: {
                ...
                speedwarning.visible =true
                speedwarning.anchors.topMargin=0
                speedwarning.source ="file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/run.png"
                speedwarning.height =(mainrect.height*0.06 + mainrect.width *0.08)/2
                speedwarning.width=(mainrect.height*0.06 + mainrect.width *0.08)/2
                starttext.text ="Start"
                starttext.color ="#FFFFE0"
    ...
    ComboBox {
        ...
        onCurrentTextChanged: {
            if(startstop){
                if(root.currentText == "Color Sorting"){unityWidgetClass.colorcomand();}
            }
    ...
    DashboardGaugeStyle {
        ...
        onValueChanged: {
            if(value>75){
                ...
                speedwarning.visible =true
                speedwarning.anchors.topMargin=0
                speedwarning.source ="file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/speedwarning.png"
    ...
    Rectangle{
        ...
        Slider{
            ...
            handle: Image {
                id:handle
                source:"file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/speedarrow.png"
    ...
    Rectangle{
        ...
        Rectangle {
            ...
            Image {
                source:"file:///C:/Users/Administrator/Desktop/Qt_controls_Unity/images/axisarrow.png"
                id: axis1mover
                ...
                MouseArea {
                    ...
                    onPositionChanged: {
                        ...
                        if(startstop && speedometer.value > 0 ){
                            axis1mover.x < (axis1line.width - axis1mover.width) / 2 ?  unityWidgetClass.changeVal("left|"+speedometer.value) : unityWidgetClass.changeVal("right|"+speedometer.value)
                            unityWidgetClass.sendval("b")
                        }
                        else{
                            change()
                        }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    onPositionChanged: {
                        ...
                        if(startstop && speedometer.value > 0){
                            axis2mover.x < (axis2.width - axis2mover.width) / 2 ?  unityWidgetClass.changeVal("pole1forward|"+speedometer.value) : unityWidgetClass.changeVal("pole1backward|"+speedometer.value)
                            unityWidgetClass.sendval("s");
                        }
                        else{
                            change()
                        }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    onPositionChanged: {
                        ...
                        if(startstop && speedometer.value > 0){
                            axis3mover.x < (axis3.width - axis3mover.width) / 2 ?  unityWidgetClass.changeVal("pole2forward|"+speedometer.value) : unityWidgetClass.changeVal("pole2backward|"+speedometer.value)
                            unityWidgetClass.sendval("e")
                        }
                        else{
                            change()
                        }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    onPositionChanged: {
                        ...
                        if(startstop && speedometer.value > 0){
                            axis4mover.x < (axis4.width - axis4mover.width) / 2 ?  unityWidgetClass.changeVal("rotateleft|"+speedometer.value) : unityWidgetClass.changeVal("rotate|"+speedometer.value)
                            unityWidgetClass.sendval("w")
                        }
                        else{
                            change()
                        }
            ...
            Image {
                ...
                MouseArea {
                    ...
                    onPositionChanged: {
                        ...
                        if(startstop && speedometer.value > 0){
                            axis5mover.x < (axis5.width - axis5mover.width) / 2 ?  unityWidgetClass.changeVal("p44|"+speedometer.value) : unityWidgetClass.changeVal("p446|"+speedometer.value)
                            unityWidgetClass.sendval("f")
                        }else{
                            change()
                        }
                    }
        ...
        Label{
            id:axis0text
            anchors.right:axis0.left
            anchors.rightMargin: 55
            font.pointSize:(mainrect.height*0.06 + mainrect.width*0.10)/13
            anchors.bottom: axis0.top
            anchors.bottomMargin: -5
            color:"white"
            text:"Position"
        }
        Rectangle {
            ...
            Image {
                ...
                width: (mainrect.height*0.10 +  mainrect.width*0.10)/8.7
                height:  (mainrect.height*0.10 +  mainrect.width*0.10)/8.7
                anchors.top: axis0.bottom
                x: axis0.width / 2 - axis0mover.width / 2
                MouseArea {
                    id: axis0mouse
                    anchors.fill: parent
                    drag.target: axis0mover
                    drag.axis: Drag.XAxis
                    onPositionChanged: {
                        axis0mover.x < (axis0.width - axis0mover.width) / 2 ? axis0d.font.pointSize=15 : axis0u.font.pointSize=15
                        axis0mover.x < (axis0.width - axis0mover.width) / 2 ? axis0u.font.pointSize=10 : axis0d.font.pointSize=10
                        if(startstop){
                            axis0mover.x < (axis0.width - axis0mover.width) / 2 ? unityWidgetClass.changeVal("rightb|"+"0.5") : unityWidgetClass.changeVal("leftb|"+"0.5");
                            unityWidgetClass.sendval("t")
                        }
                        else{
                            change()
                    ...
                    onPressed: {
                        axis0text.font.bold=true
                        axis0text.font.pointSize =15
                        axis0.height = (mainrect.height+mainrect.width)/400
                        axis0u.font.bold=true
                        axis0d.font.bold=true
                    }
                    onReleased: {
                        unityWidgetClass.stopSending()
                        unityWidgetClass.sendval("n")
                        axis0text.font.bold=false
                        axis0u.font.pointSize=10
                        axis0d.font.pointSize=10
                        axis0text.font.pointSize =(mainrect.height*0.06 + mainrect.width*0.10)/13
                        axis0.height = (mainrect.height+mainrect.width)/550
                        axis0d.font.bold=false
                        axis0u.font.bold=false
                        axis0mover.x = axis0.width / 2 - axis0mover.width / 2;
                    }
                }
                onXChanged: {
                    if (axis0mover.x < 0) {
                        axis0mover.x = 0;
                    } else if (axis0mover.x > axis0.width - axis0mover.width) {
                        axis0mover.x = axis0.width - axis0mover.width;
                    }
                }
            }
            Label{
                id:axis00text
                anchors.right:axis00.left
                anchors.rightMargin: 55
                font.pointSize:(mainrect.height*0.06 + mainrect.width*0.10)/13
                anchors.bottom: axis00.top
                anchors.bottomMargin: -5
                color:"white"
                text:"Position"
            }
            Rectangle {
                ...
                Image {
                    ...
                    width: (mainrect.height*0.10 +  mainrect.width*0.10)/8.7
                    height:  (mainrect.height*0.10 +  mainrect.width*0.10)/8.7
                    anchors.top: axis00.bottom
                    x: axis00.width / 2 - axis00mover.width / 2
                    MouseArea {
                        id: axis00mouse
                        anchors.fill: parent
                        drag.target: axis00mover
                        drag.axis: Drag.XAxis
                        onPositionChanged: {
                            axis00mover.x < (axis00.width - axis00mover.width) / 2 ? axis00d.font.pointSize=15 : axis00u.font.pointSize=15
                            axis00mover.x < (axis00.width - axis00mover.width) / 2 ? axis00u.font.pointSize=10 : axis00d.font.pointSize=10
                            if(startstop){
                                axis00mover.x < (axis00.width - axis00mover.width) / 2 ? unityWidgetClass.changeVal("backwardb|"+"0.5") : unityWidgetClass.changeVal("forwardb|"+"0.5");
                                unityWidgetClass.sendval("t")
                            }
                            else{
                                change()
                        ...
                        onPressed: {
                            axis00text.font.bold=true
                            axis00text.font.pointSize =15
                            axis00.height = (mainrect.height+mainrect.width)/400
                            axis00u.font.bold=true
                            axis00d.font.bold=true
                        }
                        onReleased: {
                            unityWidgetClass.stopSending()
                            unityWidgetClass.sendval("n")
                            axis00text.font.bold=false
                            axis00u.font.pointSize=10
                            axis00d.font.pointSize=10
                            axis00text.font.pointSize =(mainrect.height*0.06 + mainrect.width*0.10)/13
                            axis00.height = (mainrect.height+mainrect.width)/550
                            axis00d.font.bold=false
                            axis00u.font.bold=false
                            axis00mover.x = axis00.width / 2 - axis00mover.width / 2;
                        }
                    }
                    onXChanged: {
                        if (axis00mover.x < 0) {
                            axis00mover.x = 0;
                        } else if (axis00mover.x > axis00.width - axis00mover.width) {
                            axis00mover.x = axis00.width - axis00mover.width;
                        }
                    }
                }
            }
